...
import com.yijiu.newcoin.databinding.ActivityWebviewBinding;
...
public class WebviewAty extends BaseAty {
    ...
    private String idUrl="http://192.168.100.249/";
    @Override
    protected void initData() {
        super.initData();

        mBinding.close.findViewById(R.id.close).setOnClickListener(new View.OnClickListener() {
            @Override
...
//        mBinding.WebView.loadUrl("http://h5.xiyou.com/pages/setting/loginPwd");
        mBinding.WebView.loadUrl(idUrl+"pages/setting/loginPwd");
