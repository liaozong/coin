...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (UIUtils.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, UIUtils.getContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = UIUtils.getContext()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(UIUtils.getContext()).hasPermanentMenuKey();
